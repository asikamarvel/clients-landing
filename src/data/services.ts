...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortTitle: 'Software',
    tagline: 'Tailored systems that automate and scale',
    description: 'We develop custom software solutions designed to automate complex workflows, streamline operations, and integrate with your existing infrastructure. From standalone applications to enterprise-grade systems, we build software that fits your specific business requirements.',
    icon: icons.software,
    ...
    approach: [
      'Operational audit to identify high-value automation opportunities',
      'System architecture design with defined goals and evaluation criteria',
      'Iterative development with rapid prototyping and testing',
      'Production deployment with monitoring and documentation',
      'Ongoing optimization informed by performance metrics and user feedback',
    ],
  },
  {
    slug: 'erp-solutions',
